...
public class PlatformerScenario implements Scenario {
    ...
    public PlatformerScenario(MapEditor mapEditor){
    ...
    public void resurrectHero(){
        ...
        /*if(game.getCurrentScreen() instanceof PlatformerScreen){
            PlatformerScreen platformerScreen = ((PlatformerScreen)game.getCurrentScreen());
            platformerScreen.putPlayer(getXYToResurrect(currentMapTer.getCol(), 20,
    ...
    public void setLivesIcon(){
        /*if(lives >= 9){
            controlPanel.getIcon(2).setAssetStartX((lives + 1) / 10);
            controlPanel.getIcon(2).setAssetStartY(0);

            controlPanel.getIcon(3).setAssetStartX((lives + 1) % 10);
            controlPanel.getIcon(3).setAssetStartY(0);
        }
        else{
            controlPanel.getIcon(2).setAssetStartX(lives + 1);
            controlPanel.getIcon(2).setAssetStartY(0);

            controlPanel.getIcon(3).setAssetStartX(-1);
